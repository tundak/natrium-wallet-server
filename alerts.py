...
ACTIVE_ALERTS = [
    {
        ...
        "de": {
            ...
            "long_description": "Das Nano-Netzwerk kämpft derzeit mit Problemen, die durch eine lang andauernde Serie von Spam-Transaktionen ausgelöst wurden.\n\nManche Transaktionen können daher stark verzögert sein, teilweise um bis zu mehrere Tage. Wir werden unsere Nutzer über wichtige Neuigkeiten informieren, sobald das Nano-Team diese veröffentlicht.\n\nErfahre mehr, indem du auf \"Read More\" klickst.\n\nDie Probleme mit verzögerten Transaktionen sind ausgelöst durch das Nano-Netzwerk, nicht durch Natrium. Wir stehen nicht in Verbindung mit der Nano Foundation oder ihren Entwicklern und können daher nichts tun, um die Transaktionen zu beschleunigen.\n\nDanke für deine Geduld in dieser Zeit.",   
        },
        "fr": {
